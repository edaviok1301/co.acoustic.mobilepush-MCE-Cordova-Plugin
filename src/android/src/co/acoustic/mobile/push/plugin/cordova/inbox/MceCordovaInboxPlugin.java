...
package co.acoustic.mobile.push.plugin.cordova.inbox;

import co.acoustic.mobile.push.plugin.cordova.CordovaJsonCallback;
import co.acoustic.mobile.push.sdk.js.inbox.MceJsonApi;
...
public class MceCordovaInboxPlugin extends CordovaPlugin {
   @Override
